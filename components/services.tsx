...
const services = [
  {
    title: "Delivery",
    desc: "Food, beverages, medicines and essentials delivered fast with real‑time tracking.",
    imgQuery:
  ...
  },
  {
    ...
    desc: "Reliable rides with verified drivers and transparent fares.",
    imgQuery:
  ...
  },
  {
    ...
    desc: "On‑site diagnostics and partner workshops for bigger jobs.",
    imgQuery:
  ...
  {
    title: "Tow & Roadside",
    desc: "Emergency towing, batteries, tires, and jump starts—24/7.",
    imgQuery:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/attachments/gen-images/public/images/services/roadside-assistance-KNoiSvS9oxvN57BCYtZ73yGshgTRDi.jpg",
  },
  {
    title: "Errand Runner",
    desc: "Queueing, drop‑offs, pick‑ups—get time back in your day.",
    imgQuery:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/attachments/gen-images/public/images/services/courier-flYKwsNz0CRm7M5d1QeJnOVub5Ahqf.jpg",
  },
  {
    title: "Last‑Mile B2B",
    desc: "Bulk dispatching API for merchants with delivery SLAs.",
    imgQuery:
...
export function Services() {
  ...
  return (
    <SectionShell
      id="services"
      title="Services"
      description="Everything you need, fulfilled by vetted professionals."
    >
      <M.ul
        {...container}
